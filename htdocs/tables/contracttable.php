...
<button id="button">
<a href="../forms/update_contract.php" class="button">Update Contract Record</a>
</button>
<button id="button">
<a href="../forms/add_contract.html" class="button">Add Contract Record</a>
</button>
<button id="button">
<a href="../search/contractsearch.php" class="button">Search</a>
</button>
</body>
</html>