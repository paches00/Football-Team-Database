...
<button id="button">
<a href="../forms/update_match.php" class="button">Update Match Record</a>
</button>
<button id="button">
<a href="../forms/add_match.html" class="button">Add Match Record</a>
</button>
<button id="button">
<a href="../search/matchsearch.php" class="button">Search</a>
</button>
</body>
</html>