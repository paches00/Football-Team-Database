...
<center>
Enter password: <input id='password' type='text' placeholder="Player"/>
<button id="button">
<a href="/views/player.php" onclick="javascript:return validatePass()">Continue</a>
</button>
</center>
</div>
<script>
function validatePass(){
    if(document.getElementById('password').value == 'player'){
        return true;
    }else{
