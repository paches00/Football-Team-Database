...
<center>
Enter password: <input id='password' type='text' placeholder="Director"/>
<button id="button">
<a href="/views/director.php" onclick="javascript:return validatePass()">Continue</a>
</button>
</center>
</div>
<script>
function validatePass(){
    if(document.getElementById('password').value == 'director'){
        return true;
    }else{
