...
<center>
Enter password: <input id='password' type='text' placeholder="Analytics"/>
<button id="button">
<a href="/views/analytics.php" onclick="javascript:return validatePass()">Continue</a>
</button>
</center>
</div>
<script>
function validatePass(){
    if(document.getElementById('password').value == 'analytics'){
        return true;
    }else{
