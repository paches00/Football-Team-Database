...
<center>
Enter password: <input id='password' type='text' placeholder="Owner"/>
<button id="button">
<a href="/views/owner.php" onclick="javascript:return validatePass()">Continue</a>
</button>
</center>
</div>
<script>
function validatePass(){
    if(document.getElementById('password').value == 'owner'){
        return true;
    }else{
