...
<?php
	if(isset($_POST['add'])) {
			...
			$sql = "INSERT INTO player('id', 'current_team_id', 'first_name', 
			'middle_name', 'surname', '$date_of_birth', 'height', 'weight_in_kg', 
			'position', 'experience_clubs', 'experience_international', 'previous_team_ids', 
			'address_home_ground', 'player_type') VALUES ('$player_id', '$player_current_team_id', '$player_first_name', 
